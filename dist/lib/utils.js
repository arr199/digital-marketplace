...
function formatPrice(price, options) {
    ...
    var numberPrice = typeof price === 'string' ? Number(price) : price;
    return new Intl.NumberFormat('en-US', { style: 'currency', currency: currency, notation: notation, maximumFractionDigits: 2 })
        .format(numberPrice);
}
