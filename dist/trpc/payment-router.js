...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var user, productIds, payload, products, validProducts, order, lineItems, stripeSession, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        validProducts = products.filter(function (product) { return Boolean(product.priceId); });
                        return [4 /*yield*/, payload.create({
                                collection: 'orders',
                                data: {
                                    isPaid: false,
                                    products: validProducts.map(function (prod) { return prod.id; }),
                                    user: user.id
                                }
                            })
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        order = orders[0];
                        return [2 /*return*/, { isPaid: order.isPaid }];
                }
            });
        });
    })
