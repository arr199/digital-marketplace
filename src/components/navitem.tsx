...
export default function NavItem ({ category, isAnyOpen, handleOpen, isOpen }: NavItemsProps): JSX.Element {
  return (
        ...
        <div className="flex">
            ...
            variant={isOpen ? 'secondary' : 'ghost'} >
                {category.label}
                <ChevronDown className={clsx('h4 w-4 transition-all text-muted-foreground',
                  {
                    '-rotate-180': isOpen
                  })}>
                </ChevronDown>
